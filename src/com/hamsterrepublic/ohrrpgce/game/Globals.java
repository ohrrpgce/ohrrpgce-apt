...
class Globals
{
	...
	public static String ApplicationName = "OHRRPGCEGame";
	public static String AppLibraries[] = { "sdl-1.2", "sdl_mixer" };
	public static final boolean Using_SDL_1_3 = false;
	public static String[] DataDownloadUrl = { "!Game Data|gamedata.zip",  };
	...
	public static String ReadmeText = "Testing";
	...
	public static String[] AppTouchscreenKeyboardKeysNames = "Enter ESC".split(" ");
	public static int StartupMenuButtonTimeout = 0;
	public static int AppMinimumRAM = 8;
